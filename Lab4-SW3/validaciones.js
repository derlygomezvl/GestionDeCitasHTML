...
/* VALIDACIONES DE LOS MEDICOS */
function mostrarEspecialidad(tipo){
    let descripcion = document.getElementById("descripcionEspecialidad");
    if(tipo==="Terapia Neural"){
    descripcion.innerHTML="La Terapia Neural regula el sistema nervioso mediante anestésicos locales.";
    }
    if(tipo==="Quiropraxia"){
    descripcion.innerHTML="La Quiropraxia trata problemas musculoesqueléticos mediante ajustes manuales.";
    }
    if(tipo==="Fisioterapia"){
    descripcion.innerHTML="La Fisioterapia ayuda a recuperar movilidad y aliviar dolor muscular.";
    }
    if(tipo==="Nutricion"){
    descripcion.innerHTML="La Nutrición Terapéutica mejora la salud mediante alimentación especializada.";
    }
}
